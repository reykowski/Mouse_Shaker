...
public class xconfig_led
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('xconfig_led$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['xconfig_led$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['xconfig_led$$stat$root'];\n");
        sb.append("}\n");
